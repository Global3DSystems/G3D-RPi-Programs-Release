...
G3D-RPi-Programs-Release-master.zip in the root of flash drive.
    ...
    def check_extract_update(self):
        ...
        for dir_to_scan in os.listdir(USB_MOUNT_DIR):
            ...
            if TARGET_FILE_NAME in os.listdir(dir_to_scan_full_path):
                ...
                # /media/username/usbname/G3D-RPi-Programs-Release-master.zip
...
if __name__ == "__main__":
    ...
    # the old one in home.
    # Delete: /home/pi/G3D-RPi-Programs-Release-master
    # Copy:   /home/pi/Downloads/G3D-RPi-Programs-Release-master
    # to /home/pi
